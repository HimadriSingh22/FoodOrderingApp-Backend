...
public class RestaurantController {
    ...
    @RequestMapping(method = RequestMethod.GET , path = "/api/restaurant/{retaurant_id}",consumes = MediaType.APPLICATION_JSON_UTF8_VALUE,produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public ResponseEntity<RestaurantDetailsResponse> getRestaurantById(@PathVariable("restaurant_uuid")final String restaurant_uuid)throws RestaurantNotFoundException
    {
        ...
        RestaurantDetailsResponse restaurantDetailsResponse = new RestaurantDetailsResponse().id(UUID.fromString(restaurantEntity.getRestaurant_uuid()))
                .restaurantName(restaurantEntity.getRestaurant_name()).customerRating(restaurantEntity.getCustomer_rating()).averagePrice(restaurantEntity.getAvg_price_for_two())
